                ...
                <div class="card-body">
                    <table class="table card-table table-vcenter text-nowrap" id="koby_table">
                        ...
                        <tbody>
                            ...
                            <?php
                            $list = $con->query("SELECT * FROM the_hotel_room_features_group ORDER BY rank ASC");
                            while ($view = $list->fetch_object()) {
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <a href="hotel-features-group-edit?id=<?= $view->features_gid ?>"
                                            class="btn btn-blue btn-sm" data-toggle="tooltip" title="Bearbeiten"><i
                                                class="fe fe-edit"></i> </a>
                                        <a href="javascript:void(0)"
                                            onclick="kobySingle('<?= $view->features_gid ?>','?do=hotel-features-group&q=delete','hotel-features-group')"
