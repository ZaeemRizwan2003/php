...
<?php
$id = g('id');
$view = $con->query("SELECT * FROM the_hotel_room_features WHERE features_id = '$id'")->fetch_object();
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <fieldset class="form-fieldset">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="feature_group_id" id="feature_group_id"
                                        ...
                                        while ($ozellikGrup = $ozellikGruplari->fetch_object()) {
                                            ?>
                                            <option value="<?= $ozellikGrup->features_gid ?>" <?php if ($view->feature_group_id == $ozellikGrup->features_gid) {
                                                echo 'selected';
                                            } ?>><?= $ozellikGrup->name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <button type="submit"
                                    onclick="kobySubmit('?do=hotel-features&q=edit&id=<?= $view->features_id ?>','hotel-features')"
