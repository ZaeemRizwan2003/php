        ...
        <form action="?q=social_networks" method="POST">
            <div class="card">
                <div class="card-header" style="display: block;">
                    <a href="hotel-features-add" class="btn btn-indigo"> <i class="fe fe-plus"></i> Special hinzufügen
                    </a>
                    <a href="hotel-features-group-add" class="btn btn-indigo"> <i class="fe fe-plus"></i> Gruppe
                        hinzufügen </a>
                ...
                <div class="card-body">
                    <table class="table card-table table-vcenter text-nowrap" id="koby_table">
                        ...
                        <tbody>
                            ...
                            <?php
                            $list = $con->query("SELECT * FROM the_hotel_room_features ORDER BY rank ASC");
                            while ($view = $list->fetch_object()) {
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <?php
                                        $Category = $con->query("SELECT * FROM the_hotel_room_features_group WHERE features_gid = '$view->feature_group_id'")->fetch_object();
                                        echo $Category->name;
                                        ?>
                                    </th>
                                    <th class="text-center">
                                        ...
                                        <a href="hotel-features-edit?id=<?= $view->features_id ?>" class="btn btn-blue btn-sm"
                                            data-toggle="tooltip" title="Bearbeiten"><i class="fe fe-edit"></i> </a>
                                        <a href="javascript:void(0)"
                                            onclick="kobySingle('<?= $view->features_id ?>','?do=hotel-features&q=delete','hotel-features')"
