...
<?php 
    $sorgu = $con->query("SELECT COUNT(*) FROM the_hotel WHERE status = 1");
    $sorgu = $sorgu->fetchColumn();
?>
                ...
                <div class="isotope-wrapper">
                    <div class="row">
                        ...
                        <?php
                            ...
                            $oteller = $con->query("SELECT * FROM the_hotel LIMIT $kacar OFFSET $nereden");
                            while ($otel = $oteller->fetch(PDO::FETCH_OBJ)){
                                if($otel->picture) {
                                ...
                                $proSrc = $con->query("SELECT * FROM il WHERE id = '$province'")->fetch(PDO::FETCH_OBJ);

                                $state = $otel->state;
                                $staSrc = $con->query("SELECT * FROM ilce WHERE id = '$state'")->fetch(PDO::FETCH_OBJ);
                        ?>
